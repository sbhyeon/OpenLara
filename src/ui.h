...
namespace UI {
  ...
  static const uint8 char_map[102 + 33*2] = {
    ...
    #if defined(_OS_WEB) || defined(_OS_WIN) || defined(_OS_LINUX) || defined(_OS_MAC) || defined(_OS_RPI) || defined(_GAPI_GLES)	// By Johnny
        if (showHelp) {
